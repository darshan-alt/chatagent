...
export default async function LoginPage({
  ...
  return (
    <div className="flex flex-col min-h-[100dvh] items-center justify-center bg-zinc-950 text-zinc-50 px-4">
      <div className="w-full max-w-sm p-8 space-y-6 bg-zinc-900 rounded-xl border border-zinc-800 shadow-2xl">
        <div className="space-y-2 text-center">
          <h1 className="text-3xl font-bold tracking-tighter">Welcome Back</h1>
          <p className="text-zinc-400 text-sm">Sign in to continue to ChatAgent</p>
        </div>

        {errorMsg && (
          <div className="p-3 text-xs rounded border border-red-500/50 bg-red-500/10 text-red-400 text-center">
            {errorMsg}
          </div>
        )}
        ...
        <div className="space-y-4">
          <form action="/auth/github" method="POST">
            <Button type="submit" className="w-full bg-zinc-100 text-zinc-950 hover:bg-zinc-200 font-semibold" size="lg">
